...
vm.runInContext(fs.readFileSync('../schoolconnect/assets/js/catalog.js', 'utf8'), ctx);
vm.runInContext(fs.readFileSync('../schoolconnect/assets/js/templates.js', 'utf8'), ctx);
