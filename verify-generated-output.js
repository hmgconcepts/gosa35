...
const gen = fs.readFileSync(path.join(root, '../schoolconnect/assets/js/generator.js'), 'utf8');
const tpl = fs.readFileSync(path.join(root, '../schoolconnect/assets/js/templates.js'), 'utf8');
